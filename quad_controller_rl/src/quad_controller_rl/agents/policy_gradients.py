...
class Actor:
    ...
    def __init__(self, state_size, action_size, action_low, action_high, hidden_layer_size=8):  # 64):
...
class Critic:
    ...
    def __init__(self, state_size, action_size, hidden_layer_size=8):  #64):
        """Initialize parameters and build model.
...
class DDPG(BaseAgent):
    ...
    def postprocess_action(self, action):
        ...
        complete_action[2] = action  # z linear force only
